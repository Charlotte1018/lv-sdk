...
let random = "fengyukejiyouxiangongsi";
...
* @returns {}
* */
exports.priEncrypt = function (plains) {
	let plain = plains || random;
...
* @returns {}
* */
exports.pubEncrypt = function (plains) {
	let plain = plains || random;
